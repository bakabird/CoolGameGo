...
public class WaterflowerTemplateAd implements ITemplateAdListenner {
    ...
    public WaterflowerTemplateAd(String posId, boolean force, int gravity, boolean debug, String widthMode, int widthDp,int scale,
        ...
        mTemplateAd = new TemplateAd(AppActivity.get(), adContainer, waterflowerContainer, posId, widthDp,scale,gravity, this);
